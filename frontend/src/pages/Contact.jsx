...
function Contact() {
  ...
  const initialMessage = product ? `I want to enquire about ${product}. Please share pricing and availability.` : '';
  ...
  return (
    <section className="page-section contact-page">
      <div className="container contact-header">
        <p className="eyebrow">Contact GL Healthcare</p>
        <h1>Send your dental material requirement.</h1>
        <p>
          Share the product type, quantity, clinic details, and any urgent requirement. The GL Healthcare team
          can respond with product availability, pricing, and next steps.
        </p>
      </div>
      ...
      <div className="container contact-layout enhanced-contact-layout">
        <div className="contact-info enhanced-contact-info">
          ...
          <div className="contact-mini-grid">
            ...
            <div><Building2 /><strong>Dentist</strong><span>Primary audience</span></div>
        ...
        <form className="contact-form enhanced-contact-form" onSubmit={submit}>
          <div className="form-heading">
            ...
            <p>Add products, quantity, location, and preferred contact time.</p>
          </div>
          <label>Name<input name="name" value={form.name} onChange={update} required placeholder="Clinic or contact name" /></label>
          ...
          <label>Message<textarea name="message" value={form.message} onChange={update} rows="6" required placeholder="Tell us which dental materials you need" /></label>
